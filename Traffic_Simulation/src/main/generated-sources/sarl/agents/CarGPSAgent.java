...
public class CarGPSAgent extends VehicleAgent {
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    UUID _iD = this.getID();
    String _plus = ("CarGPSAgent was started." + _iD);
    ...
    requestAStar _requestAStar = new requestAStar();
  ...
  private void $behaviorUnit$Destroy$1(final Destroy occurrence) {
    Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.info("CarGPSAgent was stopped.");
  }
  ...
  private void $behaviorUnit$AgentSpawned$3(final AgentSpawned occurrence) {
    Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.info("CarGPSAgent spawned ");
  }
  ...
  @SyntheticMember
  public CarGPSAgent(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public CarGPSAgent(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public CarGPSAgent(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
