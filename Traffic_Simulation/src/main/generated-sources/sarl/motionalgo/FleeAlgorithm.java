...
public interface FleeAlgorithm {
  /**
   ...
   */
  public abstract MotionAlgorithmOutput run(final Point2f position, final float linearSpeed, final float maxLinear, final Point2f target);
}
