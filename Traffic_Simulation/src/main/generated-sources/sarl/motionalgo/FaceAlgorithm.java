...
public interface FaceAlgorithm {
   ...
   */
  public abstract MotionAlgorithmOutput run(final Point2f position, final Vector2f orientation, final float angularSpeed, final float maxAngular, final Point2f target);
}
