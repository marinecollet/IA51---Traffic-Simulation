...
public class EntityClickable extends Entity implements EntityUpdateable {
   ...
   */
  public EntityClickable(final EventEntityMouseClicked _clickedEvent, final Vector2f _position, final Vector2f _size) {
   ...
   * La taille de l'entit�
   */
  public EntityClickable(final Vector2f _position, final Vector2f _size) {
    super(_position, _size, true, true);
   ...
   * La position de l'entit�
   */
  public EntityClickable(final Vector2f _position) {
  ...
  public void setClickedEvent(final EventEntityMouseClicked ev) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    EntityClickable other = (EntityClickable) obj;
